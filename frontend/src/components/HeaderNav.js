...
const navigation = [
    { name: 'Convocations', href: '/' },
    { name: 'Edition Convocations', href: '/convocations' },
    { name: 'Gestion Licenciés', href: '/licencies' },
    { name: 'Gestion Équipes', href: '/equipes' },
];
                            ...
                            <div className="border-b border-yellow-200">
                                <div className="flex h-16 items-center justify-between px-4 sm:px-0">
                                    ...
                                    <div className="hidden md:block">
                                        ...
                                        >
                                            <ArrowLeftEndOnRectangleIcon className="h-5 w-5 inline-block -mt-1 mr-2" aria-hidden="true" />
                                            Déconnexion
                                        </button>
                                    </div>
